...
// Claude Code
export const CLAUDE_MODELS = ["claude-opus-4-6", "claude-sonnet-4-6", "claude-haiku-4-5-20251001"] as const;
...
// Codex (OpenAI)
export const CODEX_MODELS = ["gpt-5.4", "gpt-5.4-mini"] as const;
export type CodexModel = (typeof CODEX_MODELS)[number];

// Cursor
export const CURSOR_MODELS = ["claude-opus-4-6", "claude-sonnet-4-6", "claude-haiku-4-5-20251001"] as const;
